    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "PropertyManager", "PROPERTYMANAGER" },
                    { "2", null, "Tenant", "TENANT" },
                    { "3", null, "MaintenanceStaff", "MAINTENANCESTAFF" }
                });

            migrationBuilder.InsertData(
                table: "Properties",
                columns: new[] { "PropertyId", "Address", "Bedrooms", "City", "Description", "MonthlyRent", "PropertyType", "Status" },
                values: new object[,]
                {
                    { 1, "123 Pearl Boulevard", 2, "Manama", "Modern apartment near the city center", 350m, 0, 0 },
                    { 2, "45 Seef District", 4, "Manama", "Spacious villa with private garden", 800m, 1, 0 },
                    { 3, "78 Riffa Valley Road", 0, "Riffa", "Commercial shop in busy area", 500m, 2, 0 }
                });
